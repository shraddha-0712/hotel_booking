    ...
    return (
        ...
        pt-20 pb-30'>
            <div className='flex flex-col md:flex-row items-center justify-between w-full'>
                ...
                our limited-time offers and special packages to enchance your stay and
            ...
            <div className='grid grid-cols-2 lg:grid-cols-3 gap-6 mt-12'>
                {exclusiveOffers.map((item) => (
                    ...
                    bg-cover bg-center' style={{ backgroundImage: `url(${item.image})` }}>
                        <p className='px-3 py-1 absolute top-4 text-xs bg-white text-gray-800
                        ...
                        <button className='flex items-center gap-2 font-medium cursor-pointer mt-4 md:mb-5'>
                            View Offers
