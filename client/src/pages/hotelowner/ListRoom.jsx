...
const ListRoom = () => {
  ...
  return (
    <div>
      ...
      up-to-date to provude the best experience for users.' />
                ...
                <tr key={index}>
                  ...
                  <td className='py-3 px-4 border-t border-gray-300 text-sm text-red-500 text-center'>
                      <label className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                        ...
                        <div className='w-12 h-7 bg-slate-300 rounded-full peer-checked:bg-blue-600 transition-color duration-200'></div>
